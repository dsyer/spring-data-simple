...
public @interface EnableSimpleRepositories {
	 ...
	 * declarations e.g.: {@code @EnableSimpleRepositories("org.my.pkg")} instead of
	 * {@code @EnableSimpleRepositories(basePackages="org.my.pkg")}.
	 */
	 ...
	 * for query methods. Defaults to {@link Key#USE_DECLARED_QUERY}.
	 * 
	 * @return
	 */
	 ...
	 * file. Will default to empty (since it doesn't necessarily have an implementation
	 ...
	 * Defaults to {@link JpaRepositoryFactoryBean}.
	 * 
	 * @return
	 */
